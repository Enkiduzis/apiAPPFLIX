...
// Alterar para uma chave segura e n�o compartilhar
...
// Fun��o para gerar um token de acesso com expira��o de 5 minutos
...
// Ir� retornar a URL para download do arquivo criptografado
...
app.get('/file/:filename', (req, res) => {
  ...
  try {
    ...
    const iv = crypto.randomBytes(16); // Vetor de inicializa��o aleat�rio
...
// Ir� retornar o arquivo para download com o nome original
